...
struct PopupView: View {
    ...
    var body: some View {
        ...
        // Automatically process the clipboard URL when the popup appears.
        .onAppear {
                ...
                if command.useResponseWindow {
                    ...
                    await MainActor.run {
                        let window = ResponseWindow(
                            ...
                            option: .proofread // Using proofread as default for custom commands
                        )
                    ...
                    // Set clipboard content and simulate paste
    ...
    // Simulate paste command using CGEvent
